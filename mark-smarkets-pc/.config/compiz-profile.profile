...
[core]
s0_active_plugins = core;composite;opengl;crashhandler;decor;imgpng;mousepoll;matecompat;resize;grid;compiztoolbox;copytex;screenshot;place;regex;thumbnail;put;commands;move;session;switcher;animation;winrules;workarounds;fade;
s0_outputs = 1440x2560+1440+0;1440x2560+2880+0;1440x2560+0+0;
s0_autoraise = false
...
s0_put_next_output_key = <Control><Super>Right
s0_put_previous_output_key = <Control><Super>Left
...
s0_put_bottomleft_key = Disabled
s0_put_bottomright_key = Disabled
s0_put_maximize_key = <Control><Super>space
...
[screenshot]
s0_selection_outline_color = #ff00779f
s0_selection_fill_color = #2f2f4f4f
s0_directory = /home/mark/Dropbox/Work/Smarkets/Pictures/Screenshots
...
[place]
s0_mode = 1
s0_position_matches = class=Slack;
s0_position_x_values = 0;
s0_position_y_values = 1308;
s0_position_constrain_workarea = false;
s0_mode_matches = class=Mate-terminal;
s0_mode_modes = 3;
